...
for year in years:
    ...
    fig = ax.get_figure()
    fig.savefig('graphs/' + str(year) + '_RFR_predicted.png')


    predictions_df_list_average = predictions_df_list[['average_predicted_price', 'average_actual_price']]
    ax =predictions_df_list_average.plot()
    fig = ax.get_figure()
    fig.savefig('graphs/' + str(year) + '_RFR_average_predicted.png')

# git rm -q /deep_learning/numerai/numerai_training_data.csv
#
# git rm --cached deep_learning/numerai/numerai_training_data.csv
# git rm /deep_learning/numerai/numerai_training_data.csv
# git filter-branch --force --index-filter git rm --cached --ignore-unmatch deep_learning/numerai/numerai_training_data.csv --prune-empty --tag-name-filter cat -- --all
